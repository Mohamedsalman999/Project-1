...
class Test_Salman:
  ...
  # Test Login
    def test_Login(self, booting_function):
       ...
       sleep(5)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators.select).click()
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators.delete).click()
       sleep(5)
